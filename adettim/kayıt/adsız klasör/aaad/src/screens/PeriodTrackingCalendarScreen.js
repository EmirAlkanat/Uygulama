...
const PeriodTrackingCalendarScreen = () => {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          <Text style={styles.title}>Regli Takip</Text>
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.infoTitle}>Regli Takibi</Text>
          <Text style={styles.infoText}>
            Bir tarihe dokunarak regli başlangıcını işaretleyebilirsiniz. Seçilen tarih lavanta rengi ile vurgulanacaktır.
          </Text>
        </View>
      </ScrollView>
...
export default PeriodTrackingCalendarScreen; 