        ...
        <SafeAreaView style={{ flex: 1 }}>
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{paddingBottom: 40}}>
            <Animated.View style={[styles.content, { opacity: fadeAnim }]}> 
              {/* En üste başlık */}
              <Text style={{ color: '#A78BFA', fontSize: 44, fontWeight: 'bold', textAlign: 'center', marginTop: 40, marginBottom: 8, letterSpacing: 1.5, textShadowColor: '#fff', textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 8 }}>Profil</Text>
