  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (savedEmail === email && savedPassword === password) {
        // Giriş başarılı - kullanıcı bilgilerini kontrol et
        ...
        if (periodLength && cycleLength) {
          // Kullanıcı daha önce bilgilerini girmiş
          navigation && navigation.replace && navigation.replace('MainTabs');
        } else {
          // Kullanıcı ilk kez giriş yapıyor, bilgileri girmesi gerekiyor
          navigation && navigation.replace && navigation.replace('IntroForm');
        }
      } else {
            ...
            <Animated.View style={[styles.content, { opacity: fadeAnim }]}>              
              ...
              <View style={styles.header}>
                <View style={styles.logoContainer}>
                  <Image source={require('../../assets/images/adet.png')} style={{ width: 60, height: 60, resizeMode: 'contain' }} />
                </View>
              ...
              <View style={styles.formCard}>
                ...
                <TouchableOpacity style={styles.loginButton} onPress={handleLogin}>
                  <LinearGradient colors={['#FF6B9D', '#FF8E9E']} style={styles.loginGradient}>
                ...
                <Text style={styles.privacy}>
                  Giriş yaparak <Text style={styles.link}>Kullanım Şartları</Text> ve{' '}
